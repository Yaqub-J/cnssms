...
<body>
    <?php 
     ...
     <div class="container mt-5">
        ...
        <div class="mb-3">
          <label class="form-label">EmployeeID number</label>
          <input type="text" 
                 class="form-control"
        ...
        <div class="mb-3">
          ...
          <select id="subjectSelect" name="subjects[]" class="form-select" multiple>
              <?php 
              $subject_ids = str_split(trim($teacher['subjects']));
              foreach ($subjects as $subject){ 
                  $selected = in_array($subject['subject_id'], $subject_ids) ? 'selected' : '';
              ?>
